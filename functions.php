...
function load_google_fonts() {
            ...
            wp_register_style('googleFontsRighteous', 'https://fonts.googleapis.com/css?family=Righteous');
            wp_enqueue_style('googleFontsRighteous');
    
            wp_register_style('googleFontsCairo', 'https://fonts.googleapis.com/css?family=Cairo');
